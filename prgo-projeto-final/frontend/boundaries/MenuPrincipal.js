...
export default function TelaMenuPrincipal() {
  ...
  const { modoBaixoEstimulo, modoNavegacaoAmpliada } = useAcessibilidade();
  ...
  const isIsento = usuarioLogado?.isento === true;
  ...
  return (
      <View style={[styles.container, { backgroundColor: modoBaixoEstimulo ? '#e0e0e0' : '#fff' }]}>
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.headerTop}>
            ...
            <View style={styles.headerTextContainer}>
              <Text style={[styles.greetingTitle, { fontSize: modoNavegacaoAmpliada ? 28 : 22 }]}>Olá, {nomeExibicao}</Text>
          ...
          {isIsento ? (
              <View style={styles.saldoCard}>
                <View>
                  <Text style={styles.saldoLabel}>Status da Carteira</Text>
                  <Text style={[styles.saldoValor, { fontSize: modoNavegacaoAmpliada ? 40 : 32 }]}>Passe Livre</Text>
                </View>
              ...
              <View style={styles.saldoCard}>
                <View>
                  ...
                  <Text style={[styles.saldoValor, { fontSize: modoNavegacaoAmpliada ? 40 : 32 }]}>R$ {saldo.toFixed(2).replace('.', ',')}</Text>
                </View>
